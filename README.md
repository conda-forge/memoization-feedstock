...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/memoization-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11956&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/memoization-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `memoization` can be installed with:

```
conda install memoization
```

It is possible to list all of the versions of `memoization` available on your platform with:
